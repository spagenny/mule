...
import org.mule.modules.instagramconnect.generated.adapters.InstagramConnectConnectorCapabilitiesAdapter;
import org.mule.modules.instagramconnect.generated.adapters.InstagramConnectConnectorProcessAdapter;
...
/**
 * A {@code InstagramConnectConnectorOAuth2Adapter} is a wrapper around {@link InstagramConnectConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-02-16T01:01:20+01:00", comments = "Build UNNAMED.2762.e3b1307")
public abstract class InstagramConnectConnectorOAuth2Adapter
    extends InstagramConnectConnectorProcessAdapter
    implements OAuth2Adapter
{
    ...
    private final static Logger LOGGER = Logger.getLogger(InstagramConnectConnectorOAuth2Adapter.class);

    public InstagramConnectConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
