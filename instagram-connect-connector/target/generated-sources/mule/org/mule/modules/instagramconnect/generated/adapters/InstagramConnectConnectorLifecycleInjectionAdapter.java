...
/**
 * A <code>InstagramConnectConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link InstagramConnectConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-02-16T01:01:20+01:00", comments = "Build UNNAMED.2762.e3b1307")
public abstract class InstagramConnectConnectorLifecycleInjectionAdapter
    extends InstagramConnectConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(InstagramConnectConnectorLifecycleInjectionAdapter.class);
