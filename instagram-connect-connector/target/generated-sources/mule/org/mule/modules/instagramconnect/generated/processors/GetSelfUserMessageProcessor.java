...
package org.mule.modules.instagramconnect.generated.processors;
...
/**
 * GetSelfUserMessageProcessor invokes the {@link org.mule.modules.instagramconnect.InstagramConnectConnector#getSelfUser()} method in {@link InstagramConnectConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-02-16T01:01:20+01:00", comments = "Build UNNAMED.2762.e3b1307")
public class GetSelfUserMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public GetSelfUserMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((InstagramConnectConnector) object).getSelfUser();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at InstagramConnectConnector at getSelfUser retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
